...
export function ToggleGroup({
    ...
    return (
        <ToggleGroupPrimitive
            className={cn(
                `flex w-fit *:focus-visible:z-10 dark:*:[[data-slot=separator]:has(+[data-slot=toggle]:hover)]:before:bg-input/64
                ...
                variant === 'default'
                    ? 'gap-0.5'
                    : orientation === 'horizontal'
                      ? `*:not-first:rounded-s-none *:not-first:border-s-0 *:not-last:rounded-e-none *:not-last:border-e-0
                        *:not-first:before:rounded-s-none *:not-last:before:rounded-e-none *:not-first:not-data-[slot=separator]:before:-start-[0.5px]
                        *:not-last:not-data-[slot=separator]:before:-end-[0.5px]`
                      : `flex-col *:not-first:rounded-t-none *:not-first:border-t-0 *:not-last:rounded-b-none *:not-last:border-b-0
                        *:not-first:before:rounded-t-none *:not-last:before:rounded-b-none *:not-first:not-data-[slot=separator]:before:-top-[0.5px]
                        *:not-last:not-data-[slot=separator]:before:-bottom-[0.5px] *:data-[slot=toggle]:not-last:before:hidden
                        dark:*:first:before:block dark:*:last:before:hidden`,
                className
            )}
            data-size={size}
