            ...
            <SheetViewport side={side} variant={variant}>
                <SheetPrimitive.Popup
                    className={cn(
                        ...
                        transition-[opacity,translate] duration-200 ease-in-out will-change-transform not-dark:bg-clip-padding
                        ...
                        side === 'right' &&
                            `col-start-2 w-[calc(100%-(--spacing(12)))] max-w-md border-s data-ending-style:translate-x-8
                            data-starting-style:translate-x-8`,
                        variant === 'inset' &&
...
export function SheetTitle({ className, ...props }: SheetPrimitive.Title.Props): React.ReactElement {
    return <SheetPrimitive.Title className={cn('font-heading text-xl leading-none font-semibold', className)} data-slot="sheet-title" {...props} />
}
