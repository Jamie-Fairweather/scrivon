...
export function MeterLabel({ className, ...props }: MeterPrimitive.Label.Props): React.ReactElement {
    return <MeterPrimitive.Label className={cn('text-sm font-medium text-foreground', className)} data-slot="meter-label" {...props} />
}
...
export function MeterValue({ className, ...props }: MeterPrimitive.Value.Props): React.ReactElement {
    return <MeterPrimitive.Value className={cn('text-sm text-foreground tabular-nums', className)} data-slot="meter-value" {...props} />
}
